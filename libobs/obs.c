...
static obs_source_t *obs_load_source_type(obs_data_t *source_data)
{
	...
	obs_data_set_default_obj(source_data, "pan", source->pan);
	source->pan = obs_source_get_pan_values(source_data);
	obs_source_set_pan_values(source_data, pan);
...
obs_data_t *obs_save_source(obs_source_t *source)
{
	...
	obs_data_array_t *pan  = obs_source_get_pan_values(source);
	...
	obs_data_set_array (source_data, "pan",      pan);
